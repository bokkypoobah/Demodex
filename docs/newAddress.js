  ...
  data: function () {
    return {
      ...
      newAccountActions: [
        ...
        { value: 'addStealthMetaAddress', text: 'Add Stealth Meta-Address', disabled: true },
        { value: 'generateStealthMetaAddress', text: 'Generate Stealth Meta-Address', disabled: true },
      ],
    }
  },
  computed: {
